...
<div class="card  my-1">
            @foreach ($threads as $thread)
              <div class="card-header">
                ...
                <span class="mr-2">{{__('threads.author')}} :: {{ $thread->creator->name }}</span>
              </div>
          </div>
                ...
                <div class="d-flex flex-wrap bd-highlight">
                  ...
                  @if ($thread->subscriptions)
                    <div class="p-2 bd-highlight"><span class='glyphicon glyphicon-folder-close'>{{ $thread->subscriptions->count() }}</span></div>
                  @endif
               </div>
